...
export const routes: Routes = [
  ...
  { path: 'dossier-medical', component: DossierMedicalComponent, canActivate: [authGuard, roleGuard('SOIGNANT')] },
  { path: 'mon-dossier', component: DossierMedicalComponent, canActivate: [authGuard, roleGuard('PATIENT')] },
